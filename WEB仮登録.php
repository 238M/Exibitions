...
//メール送信
    ...
    // PHPMailerのインスタンス生成
        ...
        $mail->Username = "testmailfortechbase@gmail.com"; // SMTPユーザー名（メールユーザー名）
        $mail->Password = "aEYK3nke6s"; // SMTPパスワード（メールパスワード）
        ...
        $mail->addReplyTo('testmailfortechbase@gmail.com');
        $mail->addCC('testmailfortechbase@gmail.com'); // CCで追加
        $mail->addBcc('testmailfortechbase@gmail.com'); // BCCで追加
